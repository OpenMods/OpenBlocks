...
public class TileEntityTargetRenderer extends TileEntitySpecialRenderer<TileEntityTarget> {
	...
	@Override
	public void renderTileEntityAt(TileEntityTarget target, double x, double y, double z, float partialTicks, int destroyStage) {
		GL11.glPushMatrix();
