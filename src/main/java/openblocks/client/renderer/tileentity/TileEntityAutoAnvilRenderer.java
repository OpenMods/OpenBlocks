...
public class TileEntityAutoAnvilRenderer extends TileEntitySpecialRenderer<TileEntityAutoAnvil> {
	...
	@Override
	public void renderTileEntityAt(TileEntityAutoAnvil autoanvil, double x, double y, double z, float partialTicks, int destroyStage) {
		GL11.glPushMatrix();
