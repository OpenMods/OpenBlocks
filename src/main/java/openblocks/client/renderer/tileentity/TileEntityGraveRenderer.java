...
public class TileEntityGraveRenderer extends TileEntitySpecialRenderer<TileEntityGrave> {
	...
	private static final ResourceLocation texture = OpenBlocks.location("textures/models/grave.png");
	...
	public void renderTileEntityAt(TileEntityGrave target, double x, double y, double z, float partialTicks, int destroyStage) {
		...
		if (target != null) GL11.glRotatef(-BlockUtils.getRotationFromOrientation(target.getOrientation()), 0, 1, 0);
		bindTexture(texture);
