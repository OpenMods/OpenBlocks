...
/**
 * A type converter can automatically convert objects from values returned by script engine to types needed by Java methods.
 *
 */
public interface IInboundTypeConverter {
	 ...
	 */
	public abstract Object toJava(IConverter converter, Object obj, Class<?> expected);
