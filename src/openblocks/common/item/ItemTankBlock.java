...
public class ItemTankBlock extends ItemOpenBlock {
	private LiquidTank fakeTank = new LiquidTank(
			LiquidContainerRegistry.BUCKET_VOLUME * Config.bucketsPerTank);
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list,
		...
		if (stack.hasTagCompound() && stack.getTagCompound().hasKey("tank")) {
			...
			double percent = Math.max(100.0 / fakeTank.getCapacity() * amount,
					amount > 0 ? 1 : 0);
