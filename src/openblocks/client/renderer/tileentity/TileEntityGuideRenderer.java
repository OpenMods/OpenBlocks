...
public class TileEntityGuideRenderer extends TileEntitySpecialRenderer {
	...
	private static final ResourceLocation texture = new ResourceLocation(
			"openblocks", "textures/blocks/guide.png");
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
		...
		GL11.glPushMatrix();
		OpenRenderHelper.renderCube(-0.5, -0.5, -0.5, 0.5, 0.5, 0.5,
				OpenBlocks.Blocks.guide, null);
		GL11.glPopMatrix();
		GL11.glPopMatrix();
		float scaleDelta = guide.getTimeSinceChange();
		renderShape(guide.getShape(), guide.getHeight(), guide.getWidth(),
				guide.getDepth(), x, y, z, scaleDelta);
		if (scaleDelta < 1.0) {
			renderShape(guide.getPreviousShape(), guide.getHeight(),
					guide.getWidth(), guide.getDepth(), x, y, z,
					1.0f - scaleDelta);
		}
	}
