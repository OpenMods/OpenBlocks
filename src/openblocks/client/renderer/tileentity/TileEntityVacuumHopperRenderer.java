...
public class TileEntityVacuumHopperRenderer extends TileEntitySpecialRenderer {
	...
	private static final ResourceLocation texture = new ResourceLocation(
			"openblocks", "textures/models/vacuumhopper.png");
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y,
		...
		if (surface == ForgeDirection.UP || surface == ForgeDirection.DOWN) {
			...
			GL11.glRotatef(BlockUtils.getRotationFromDirection(surface), 1, 0,
					0);
		} else {
			GL11.glRotatef(-BlockUtils.getRotationFromDirection(surface), 0, 1,
					0);
		}
