...
public class GuiVacuumHopper extends BaseGuiContainer<ContainerVacuumHopper> {
	...
	public GuiVacuumHopper(ContainerVacuumHopper container) {
		...
		xpSideSelector = new GuiComponentSideSelector(30, 30, 40.0, container.getTileEntity(), 0, null, container.getTileEntity().getXPOutputs(), false, new ISideSelectionCallback() {
			@Override
			public void onSideSelected(ForgeDirection direction) {
				getContainer().sendButtonClick(direction.ordinal());
			}
		});
		itemSideSelector = new GuiComponentSideSelector(30, 30, 40.0, container.getTileEntity(), 0, null, container.getTileEntity().getItemOutputs(), false, new ISideSelectionCallback() {
			@Override
			public void onSideSelected(ForgeDirection direction) {
