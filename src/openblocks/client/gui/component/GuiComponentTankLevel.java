	...
	public void render(Minecraft minecraft, int mouseX, int mouseY, FluidStack stack, double percentFull) {
		...
		if (stack != null && stack.getFluid() != null) {
	        ...
	        if (icon != null) {
		        ...
		        tessellator.addVertexWithUV((double)(x + 3), (double)(y + height - 3), (double)this.zLevel, (double)icon.getMinU(), (double)icon.getMaxV());
		        tessellator.addVertexWithUV((double)(x + width - 3), (double)(y + height - 3), (double)this.zLevel, (double)icon.getMaxU(), (double)icon.getMaxV());
