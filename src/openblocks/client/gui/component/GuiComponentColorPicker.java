...
public class GuiComponentColorPicker extends BaseComponent {
	...
	public void render(Minecraft minecraft, int offsetX, int offsetY, int mouseX, int mouseY) {
		...
		this.drawRect(renderX, renderY, renderX + getWidth(), renderY + getColorsHeight(), (tone.getValue()<<24) | 0xFFFFFF);
		...
		this.drawRect(renderX + pointX -1, renderY + pointY -1, renderX + pointX + 1, renderY + pointY +1, 0xCCCC0000);
	}
}
