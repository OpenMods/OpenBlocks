...
import openblocks.client.renderer.mutant.MutantRendererChicken;

public class DefinitionChicken implements IMutantDefinition {
	...
	private Vec3[] armAttachmentPoints = new Vec3[] {
			Vec3.createVectorHelper(-4F, -2.05F, 0.0F),
			Vec3.createVectorHelper(4F, -2.05F, 0.0F),
	};
	...
	public IMutantRenderer createRenderer() {
		return new MutantRendererChicken();
	}
